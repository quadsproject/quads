...
def mock_dependencies():
    ...
    # Patching QuadsApi class methods directly avoids import/attribute errors
    # on quads.server.app.quads instance during test collection.
    with patch("quads.tools.move_and_rebuild.badfish_factory", new_callable=AsyncMock) as mock_bf, \
         ...
         patch("quads.quads_api.QuadsApi.get_active_cloud_assignment", shared_get_assign), \
         patch("quads.quads_api.QuadsApi.get_current_schedules", shared_get_schedules), \
