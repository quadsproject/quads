...
def mock_dependencies():
    ...
    # NOTE: We removed patches for quads.tools.move_and_rebuild.quads.get_active_cloud_assignment
    # because that module imports 'quads' as a package, causing AttributeError on setup.
