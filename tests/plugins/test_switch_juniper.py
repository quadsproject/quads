...
class TestJuniperSwitchPlugin:
    ...
    def test_configure_host_no_interfaces(self, plugin):
        ...
        result = plugin.configure("host1.example.com", "cloud00", "cloud01")
    ...
    def test_configure_success_simple(self, mock_get_vlan, mock_juniper_class, mock_ssh_class, plugin):
    ...
    @patch("quads.plugins.builtin.switches.juniper.SSHHelper")
    def test_configure_ssh_connection_failure(self, mock_ssh_class, plugin):
    ...
    @patch("quads.plugins.builtin.switches.juniper.Juniper")
    @patch("quads.plugins.builtin.switches.juniper.get_vlan")
    def test_configure_no_vlan_detected_warning(self, mock_get_vlan, mock_juniper_class, mock_ssh_class, plugin):
    ...
    @patch("quads.plugins.builtin.switches.juniper.Juniper")
    @patch("quads.plugins.builtin.switches.juniper.get_vlan")
    def test_configure_public_vlan_conversion(self, mock_get_vlan, mock_juniper_class, mock_ssh_class, plugin):
    ...
    @patch("quads.plugins.builtin.switches.juniper.Juniper")
    @patch("quads.plugins.builtin.switches.juniper.get_vlan")
    def test_configure_juniper_set_port_failure(self, mock_get_vlan, mock_juniper_class, mock_ssh_class, plugin):
    ...
    @patch("quads.plugins.builtin.switches.juniper.Juniper")
    @patch("quads.plugins.builtin.switches.juniper.get_vlan")
    def test_configure_juniper_convert_port_public_failure(
    ...
    @patch("quads.plugins.builtin.switches.juniper.Juniper")
    @patch("quads.plugins.builtin.switches.juniper.get_vlan")
    def test_configure_multiple_switches(self, mock_get_vlan, mock_juniper_class, mock_ssh_class, plugin):
    ...
    @patch("quads.plugins.builtin.switches.juniper.Juniper")
    @patch("quads.plugins.builtin.switches.juniper.get_vlan")
    def test_configure_same_vlan_no_change(self, mock_get_vlan, mock_juniper_class, mock_ssh_class, plugin):
    ...
    @patch("quads.plugins.builtin.switches.juniper.SSHHelper")
    def test_ls_config_cloud_not_found(self, mock_ssh_class, plugin):
        """Test ls_config handles cloud not found"""
        plugin.quads.get_active_cloud_assignment.return_value = None

        plugin.ls_config("nonexistent_cloud")

        plugin.logger.error.assert_called_with("Cloud not found.")

    @patch("quads.plugins.builtin.switches.juniper.SSHHelper")
    def test_ls_config_single_host(self, mock_ssh_class, plugin):
        ...
        plugin.ls_config("cloud01", all=False)

        plugin.logger.info.assert_any_call("Cloud qinq: 1")
        assert mock_ssh.disconnect.called

    @patch("quads.plugins.builtin.switches.juniper.SSHHelper")
    def test_ls_config_all_hosts(self, mock_ssh_class, plugin):
    ...
    @patch("quads.plugins.builtin.switches.juniper.SSHHelper")
    def test_ls_config_vlan_detection_failure(self, mock_ssh_class, plugin):
    ...
    @patch("quads.plugins.builtin.switches.juniper.SSHHelper")
    def test_ls_config_last_interface_qinq_vlan(self, mock_ssh_class, plugin):
    ...
    @patch("quads.plugins.builtin.switches.juniper.Juniper")
    @patch("quads.plugins.builtin.switches.juniper.get_vlan")
    def test_configure_public_vlan_same_as_old(self, mock_get_vlan, mock_juniper_class, mock_ssh_class, plugin):
