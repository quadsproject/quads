...
class VisualsService:
    ...
    def get_metadata(self, when: str) -> Dict[str, Any]:
        ...
        # Use API client to get allocation metrics
        metrics = self.api_client.get_allocation_metrics(first_day, last_day)
    ...
    def get_hosts_summary(self, when: str) -> Dict[str, Any]:
        ...
        # Use API client to get host priority info
        hosts_data = self.api_client.get_hosts_with_allocation_priority(
    ...
    def get_host_batch(self, when: str, offset: int = 0, limit: int = 100, priority: str = "mixed") -> Dict[str, Any]:
        ...
        try:
            # Get hosts with priority ordering using API client
            hosts_batch_info = self.api_client.get_hosts_with_allocation_priority(
            ...
            daily_data = self.api_client.get_daily_allocation_data(
