...
class QuadsCli:
    ...
    def action_modify_notification(self):
        ...
        mod_notification_arg_names = [
            "fail", "success", "initial", "pre_initial",
            "pre", "one_day", "three_days", "five_days", "seven_days"]
        modify_notifications = list(filter(lambda item: self.cli_args.get(item), mod_notification_arg_names))
