# src/quads/plugins/interfaces/chat_notifier.py
"""
Chat Notifier Interface - For chat/messaging platforms

Chat notifications support:
- Rich formatting (cards, buttons, colors, emojis)
- Real-time delivery
...
class ChatNotifierPlugin(BasePlugin):
