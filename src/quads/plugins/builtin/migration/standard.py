"""
Standard Migration Plugin - Default implementation for host migration/rebuild
"""
...
class StandardMigrationPlugin(MigrationPlugin):
    """
    Standard migration plugin for moving and rebuilding hosts.
    ...
    def get_migration_info(self) -> Dict[str, Any]:
        ...
        return {
            "name": "standard",
            "description": "Standard migration plugin with hardware and provisioner support",
