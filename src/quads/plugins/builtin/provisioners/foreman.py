...
class ForemanProvisionerPlugin(ProvisionerPlugin):
    ...
    async def prepare_host_provisioning(self, hostname: str, cloud: str, os_type: str, ptable: str = None) -> bool:
        """Prepare host for provisioning"""
        return await self.foreman.prepare_host_provisioning(hostname, cloud, os_type, ptable)
