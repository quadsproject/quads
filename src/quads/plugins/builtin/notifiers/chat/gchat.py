...
from quads.plugins.interfaces.chat_notifier import ChatNotifierPlugin, ChatPriority
from quads.plugins.interfaces.notifier import NotifierPlugin  # Keep for backward compatibility

logger = logging.getLogger(__name__)


class GoogleChatNotifierPlugin(ChatNotifierPlugin, NotifierPlugin):
    """
    Google Chat notifier plugin implementing ChatNotifierPlugin interface.
