from quads.plugins.interfaces.mail_notifier import MailNotifierPlugin
...
class EmailNotifierPlugin(MailNotifierPlugin, NotifierPlugin):
    """
    Email notifier plugin implementing MailNotifierPlugin interface.
