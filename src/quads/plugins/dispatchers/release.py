    ...
    async def move_and_rebuild(
        ...
        try:
            return await self._default_plugin.move_and_rebuild(
                host, new_cloud, semaphore, rebuild, progress_id=progress_id
            )
...
async def move_and_rebuild(
    ...
    return await dispatcher.move_and_rebuild(host, new_cloud, semaphore, rebuild, progress_id=progress_id)
