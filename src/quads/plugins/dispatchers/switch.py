...
Uses SinglePluginDispatcher because switch configuration should only be
done via ONE protocol/system at a time (e.g., don't configure via multiple
switch management systems simultaneously).
"""
import logging
...
class SwitchDispatcher(SinglePluginDispatcher[SwitchPlugin]):
    ...
    This is a SinglePluginDispatcher - only ONE switch plugin is used at a time.
    """
