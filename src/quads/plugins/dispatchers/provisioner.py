...
Uses SinglePluginDispatcher because host provisioning should only be
done via ONE system at a time (e.g., don't provision via both Foreman
and AWX simultaneously).
"""
import logging
...
class ProvisionerDispatcher(SinglePluginDispatcher[ProvisionerPlugin]):
    ...
    This is a SinglePluginDispatcher - only ONE provisioner is used at a time.
    """
