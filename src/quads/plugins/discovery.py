...
class PluginDiscovery:
    ...
    def __init__(self):
        self.builtin_paths = [
            "quads.plugins_builtin.cloud_providers",
            "quads.plugins_builtin.hardware",
            "quads.plugins_builtin.notifiers",
            "quads.plugins_builtin.provisioners",
            "quads.plugins_builtin.switches",
            "quads.plugins_builtin.ticketing",
        ]
        self.external_path = Path("src/quads/plugins_external")
