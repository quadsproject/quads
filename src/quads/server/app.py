...
def create_app(test_config=None) -> Flask:
    ...
    flask_app.extensions["chat"] = get_chat_dispatcher(plugin_manager)
    flask_app.extensions["email"] = get_email_dispatcher(plugin_manager)
    flask_app.extensions["hardware"] = get_hardware_dispatcher(plugin_manager)
    ...
    flask_app.extensions["validator"] = get_validator_dispatcher(plugin_manager)
