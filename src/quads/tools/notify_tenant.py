...
def determine_action(args):
            ...
            if not _cloud:
                ...
                if _cloud_name == "cloud01":
                    ...
                    if host_count > 0:
                        ...
                        if args.post:
                            post_message(args, _ass.ticket, _ass.description, _cloud_name)
                    else:
        ...
        for _cloud_obj in _clouds:
            ...
            if _cloud_obj.name == "cloud01":
                ...
                if host_count > 0:
                    ...
                    if args.post:
                        post_message(args, _ass.ticket, _ass.description, _cloud_obj.name)
                else:
    ...
    if args.rack:
        ...
        for cloud_name in sorted(set(clouds_in_racks)):
            ...
            if args.post:
                post_message(args, _ass.ticket, _ass.description, cloud_name)
