...
class IBMCloudProvider(CloudProviderPlugin):
    """
    IBM Cloud VPC provider for cloud instance provisioning.

    Requires: ibm-cloud-sdk-core, ibm-vpc
    """

    name = "ibm_cloud"
    version = "1.0.0"
    description = "IBM Cloud VPC provider for overflow capacity"
    author = "QUADS Team"

    def initialize(self) -> bool:
        """Initialize IBM Cloud SDK"""
        try:
            from ibm_cloud_sdk_core.authenticators import IAMAuthenticator
            from ibm_vpc import VpcV1
        except ImportError:
            logger.error("IBM Cloud SDK not installed. " "Install with: pip install ibm-cloud-sdk-core ibm-vpc")
            return False
        ...
        try:
            ...
            logger.info(f"IBM Cloud provider initialized for region {self.region}")
            return True

        except Exception as e:
            logger.error(f"Failed to initialize IBM Cloud client: {e}")
            return False
    ...
    def health_check(self) -> bool:
        ...
        try:
            ...
            logger.error(f"IBM Cloud health check failed: {e}")
            return False
    ...
    async def get_available_capacity(self, instance_type: Optional[str] = None, region: Optional[str] = None) -> int:
        ...
        try:
            ...
            logger.debug(f"IBM Cloud available capacity: {available}")
            return available

        except Exception as e:
            logger.error(f"Failed to get IBM Cloud capacity: {e}")
            return 0
    ...
    async def create_instance(
        ...
        **kwargs,
        ...
        try:
            ...
            if not image:
                logger.error("No image specified and no default configured")
                return None
            ...
            logger.info(f"Created IBM Cloud instance: {instance_id}")
            ...
            logger.error(f"Failed to create IBM Cloud instance: {e}")
            return None
    ...
    async def start_instance(self, instance_id: str) -> bool:
        ...
        try:
            ...
            logger.info(f"Started IBM Cloud instance: {instance_id}")
            return True
        except Exception as e:
    ...
    async def stop_instance(self, instance_id: str) -> bool:
        ...
        try:
            ...
            logger.info(f"Stopped IBM Cloud instance: {instance_id}")
            return True
        except Exception as e:
    ...
    async def terminate_instance(self, instance_id: str) -> bool:
        ...
        try:
            ...
            logger.info(f"Terminated IBM Cloud instance: {instance_id}")
            return True
        except Exception as e:
