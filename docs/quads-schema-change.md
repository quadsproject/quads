...
1. **Migration Script Generation**
   - Generate migration script:
        ...
        > [!NOTE]
        > The migration directory will be located in the QUADS buildroot directory under: `/opt/quads/migrations`
   ...
   - The migration script will automatically generate 2 methods, the upgrade and the downgrade with autogenerated add/drop operations for the schema changes detected
