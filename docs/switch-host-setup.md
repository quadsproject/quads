...
> [!NOTE]
> As of QUADS 2.x, the RBAC setup below is performed **automatically** on
...
At this point you can **proceed with initializing QUADS** [from the main documentation](https://github.com/quadsproject/quads#quads-usage-documentation).
