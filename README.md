...
QUADS is physically limited by the VLAN limit in the [IEEE 802.1Q](https://standards.ieee.org/ieee/802.1Q/6844/) spec which specifies **4090** usable VLANS per VLAN-tagged Layer 2 network.
   ...
   > [!NOTE]
   > our current implementation we iterate VLAN assignments by 10 so that means the formula  is `4090 / 10 minus 10` for maximum available VLAN-tagged environments or _clouds_ which reduces the maximum amount of multi-tenant environments by 60% or more of this total.
...
| Component | Current Limit | RFE #589 Limit | Notes |
|-----------|---------------|----------------|-------|
| Cloud Environments | 499 | 1268 | assuming 4x interfaces max/host|
