...
When a new cloud assignment is validated and released, QUADS automatically generates a `/root/quads_env.yml` metadata file on the first host of the allocation. This file gives the cloud owner everything they need to automate against their environment without contacting the lab admin.
