...
| Self-Scheduling Hosts | [docs](/docs/quads-self-schedule.md) | Full-featured API for self-service scheduling of systems/assignments |
...
* Full-featured API for self-service scheduling of systems/assignments. [docs](/docs/quads-self-schedule.md)
